...
- (void)layoutSubviews {
	...
	if (parent) {
		self.frame =CGRectMake(-60, 250, 200, 100);
	}
...
//                                            constrainedToSize:maxSize lineBreakMode:detailsLabel.lineBreakMode];
    CGSize detailsLabelSize = [detailsLabel textRectForBounds:detailsLabel.frame limitedToNumberOfLines:detailsLabel.numberOfLines].size;
